...
public class CustomRole extends CommonMethods implements CommandInterface {
    ...
    public String getDescription() {
        return "Allows you to set a personal role and color. This role does not grant any"
                + " permissions and is disabled by default";
    }
    ...
    public guildObject run(
        ...
        if (guildEntity.getGuildOptions().getOption(GuildOptionsEnum.CustomRoleEnabled)) {
            switch (command[0]) {
                case "create":
