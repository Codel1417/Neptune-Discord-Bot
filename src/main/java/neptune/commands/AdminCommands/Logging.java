...
public class Logging extends CommonMethods implements CommandInterface {
  ...
  private void displayMenu(GuildMessageReceivedEvent event, guildObject guildEntity) {
    ...
    if (!LoggingChannel.equalsIgnoreCase("")) {
      embedBuilder.addField(
          "Channel", event.getGuild().getTextChannelById(LoggingChannel).getAsMention(), true);
    }
    ...
    logOptionsMessage
        ...
        .append(
            getEnabledDisabledIcon(
                guildEntity.getLogOptions().getOption(LoggingOptionsEnum.TextChannelLogging)))
        .append("\n");
    logOptionsMessage
        .append("Voice Activity")
        .append(
            getEnabledDisabledIcon(
                guildEntity.getLogOptions().getOption(LoggingOptionsEnum.VoiceChannelLogging)))
        .append("\n");
    logOptionsMessage
        .append("Member Activity")
        .append(
            getEnabledDisabledIcon(
                guildEntity.getLogOptions().getOption(LoggingOptionsEnum.MemberActivityLogging)))
        .append("\n");
    logOptionsMessage
