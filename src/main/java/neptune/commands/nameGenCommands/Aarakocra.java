...
public class Aarakocra implements CommandInterface {
    ...
    public guildObject run(
        ...
        String[] nm1 = {
            "", "", "", "", "", "c", "cl", "cr", "d", "g", "gr", "h", "k", "kh", "kl", "kr", "q",
            "qh", "ql", "qr", "r", "rh", "s", "y", "z"
        };
        String[] nm2 = {
            "a", "e", "i", "u", "a", "e", "i", "u", "a", "e", "i", "u", "a", "e", "i", "u", "a",
            "e", "i", "u", "a", "e", "i", "u", "a", "e", "i", "u", "ae", "aia", "ee", "oo", "ou",
            "ua", "uie"
        };
        String[] nm3 = {"c", "cc", "k", "kk", "l", "ll", "q", "r", "rr"};
        String[] nm4 = {
            "a", "e", "i", "a", "e", "i", "a", "e", "i", "a", "e", "i", "a", "e", "i", "aa", "ea",
            "ee", "ia", "ie"
        };
        String[] nm5 = {
            "", "", "", "", "c", "ck", "d", "f", "g", "hk", "k", "l", "r", "rr", "rc", "rk", "rrk",
            "s", "ss"
        };
        String result = "";
